...
import "../../CappedVoting.sol";
import "@aragon/test-helpers/contracts/TimeHelpersMock.sol";


contract VotingMock is CappedVoting, TimeHelpersMock {
    ...
    function newTokenAndVote(address _holder, uint256 _tokenAmount, string _metadata)
        ...
        returns (uint256 voteId)
    {
        token0.generateTokens(_holder, _tokenAmount);
        token1.generateTokens(_holder, _tokenAmount);
